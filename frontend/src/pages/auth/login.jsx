        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-[#1c6eff] font-medium">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-[#1c6eff] text-white py-3 px-4 rounded-md disabled:opacity-50 disabled:cursor-not-allowed font-medium text-lg"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/signup" className="text-[#1c6eff] font-medium hover:underline">
                Create one
              </Link>
            </p>
          </div>
